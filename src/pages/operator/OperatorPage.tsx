        ...
        <Card className="p-5">
          <div className="space-y-4">
            ...
            <Button
              ...
              onClick={() => {
                ...
                toast({
                  ...
                  description: "Intervenția roadside a fost preluată în demo.",
                  tone: "success"
                });
              }}
              disabled={accepted}
            >
              ...
              {accepted ? "Solicitare acceptată" : "Acceptă solicitarea"}
            </Button>
            <Button
              type="button"
              className="w-full"
              ...
              onClick={() =>
                toast({
                  ...
                  description: "ETA-ul și statusul intervenției au fost simulate.",
                  tone: "success"
                })
              }
            >
